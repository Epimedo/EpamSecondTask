...
public class Validator {
	...
	public static <E> boolean criteriaValidator(Criteria<E> criteria) throws ServiceException {
		String str = "";
		boolean bool = true;
		...
		for (Object oven : objects) {
			if (map.containsKey(oven)) {
				...
				if (digit.matcher(str).matches()) {
					...
					String border2 = str.substring(str.indexOf(paramDelimeter) + 1, str.length());
